...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Laporan Konsolidasi Penerimaan Kas </li>
    </ol>
  </nav>
...
<h3 class="page-title">
    <b>Laporan Konsolidasi Penerimaan Kas </b>
</h3>
<br/>
<div id="accordion">
    <form  method="post" action="{{ route('filter-consolidated-receipts-report') }}" enctype="multipart/form-data">
    @csrf
        ...
        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
            ...
            <div class="card-footer text-muted">
                <div class="form-actions float-right">
                    <a href="{{ route('reset-filter-consolidated-receipts-report') }}" type="reset" name="Reset" class="btn btn-danger"><i class="fa fa-times"></i> Batal</a>
...
<div class="card border border-dark">
  <div class="card-header bg-dark clearfix">
            ...
            <table id="" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                <thead>
                    <tr>
                        ...
                        <th width="20%" rowspan="2" style="vertical-align : middle;text-align:center;">Sumber</th>
                ...
                <tbody>
                   <?php 
                    ...
                    $total_amount = 0;
                    ?>
                   @foreach ($data_sales_invoice as $row)
                       <tr>
                   ...
                   @endforeach
                   <tr>
                    <th style="text-align: right" colspan="4">Total Penerimaan Kas</th>
    ...
    <div class="card-footer text-muted">
        <div class="form-actions float-right">
            <a class="btn btn-secondary" href="{{ url('/consolidated-receipts-report/print') }}"><i class="fa fa-file-pdf"></i> Pdf</a>
            <a class="btn btn-dark" href="{{ url('/consolidated-receipts-report/export') }}"><i class="fa fa-download"></i> Export Data</a>
        </div>
    </div>
  </div>
</div>
