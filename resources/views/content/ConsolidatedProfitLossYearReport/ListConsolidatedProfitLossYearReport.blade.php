@inject('CPLYR','App\Http\Controllers\ConsolidatedProfitLossYearReportController')
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active" aria-current="page">Laporan Konsolidasi Rugi / Laba Tahunan </li>
    </ol>
  </nav>
...
@section('content')
<h3 class="page-title">
    <b>Laporan Konsolidasi Perhitungan Rugi / Laba Tahunan</b>
</h3>
<br/>
<div id="accordion">
    <form action="{{ route('filter-consolidated-profit-loss-year-report') }}" method="post">
        @csrf
            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                ...
                <div class="card-footer text-muted">
                    <div class="form-actions float-right">
                        <a href="{{ route('reset-filter-consolidated-profit-loss-year-report') }}" type="reset" name="Reset" class="btn btn-danger"><i class="fa fa-times"></i> Batal</a>
  ...
  <div class="card-header bg-dark clearfix">
    ...
    <div class="card-body">
                ...
                <thead>
                    <tr>
                        <td colspan='2' style='text-align:center;'>
                            <div style='font-weight:bold'>Laporan Konsolidasi Perhitungan Rugi / Laba
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan='2' style='text-align:center;'>
                            <div>
                                Januari - {{ $CPLYR->getMonthName($month) }} {{ $year }}
                            </div>
                        </td>
                    </tr>
                    <tr>
        ...
        <div class="text-muted mt-3">
            <div class="form-actions float-right">
                <a class="btn btn-secondary" href="{{ route('print-consolidated-profit-loss-year-report') }}"><i class="fa fa-file-pdf"></i> Pdf</a>
                <a class="btn btn-dark" href="{{ route('export-consolidated-profit-loss-year-report') }}"><i class="fa fa-download"></i> Export Data</a>
            </div>
        </div>
  </div>
</div>
